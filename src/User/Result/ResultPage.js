// Strona wyników rozpoznawania banknotów
...
// Komponent wyświetlający poziome wykresy słupkowe dla modeli
...
export default function ResultsPage() {
  ...
  // Obliczam finalną predykcję na podstawie odpowiedzi serwera
  ...
  // Pobieram banknoty z bazy i sprawdzam czy rozpoznany banknot ma odpowiednik
  useEffect(() => {
    const loadBanknotesAndCheckMatch = async () => {
      try {
        ...
        // Sprawdzam czy rozpoznany banknot ma odpowiednik w bazie
        if (serverResponses && Object.keys(serverResponses).length > 0) {
          ...
          // Szukam banknotu w bazie po nazwie
